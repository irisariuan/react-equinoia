                ...
                <div className="flex items-center justify-center mb-4">
                    <div className="flex flex-col items-center justify-center">
                        <div className="flex items-center justify-center mb-4">
                            ...
                            <h1 className="text-6xl md:text-9xl text-center text-gold-400/70">Equinoia</h1>
                        </div>
                        <p className="text-gold-300 text-sm text-center">Proposed Students' Union Candidate Cabinet No.1</p>
                    </div>
                    <span className='[writing-mode:vertical-lr] text-gold-200 text-xl sm:text-lg flex-1'>2023-2024</span>
                </div>
                <div className="flex flex-col items-center justify-center">
