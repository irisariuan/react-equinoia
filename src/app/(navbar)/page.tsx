    ...
    return (
        <main className="dark:text-white">
            <motion.div animate={{ backgroundColor: ['rgb(253, 249, 238)', 'rgb(255,255,255)'] }} transition={{ duration: 3, repeat: Infinity, repeatType: 'reverse' }} className='bg-white h-screen w-full flex justify-center items-center flex-col'>
                <motion.img animate={{ scale: [0, 1], rotate: ['0turn', '1.5turn', '3turn'], boxShadow: ['0 0 0 rgba(247, 235, 205, 0)', '0 0 60px rgba(247, 235, 205, 1)'], filter: ['blur(50px)', 'blur(0px)'], transition: { duration: 0.5 } }} src="icon.jpg" alt="" className='select-none absolute z-10 rounded-full border-2 border-rice-content opacity-50' />
