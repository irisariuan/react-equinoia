    ...
    return (
        <div className="w-screen flex flex-col items-center justify-center mt-2 p-2">
            <div className="w-4/5">
                ...
                <Separator />
                <ParagraphContent marginY={4}>
                    “Eunoia” not only refers to the goodwill towards each other, which shows tolerance, kindness and helpfulness, but it also refers to the friendliness and respect between the presenter and the listener. From the perspective of students, the Students’ Union serves as a bridge between them and the college, allowing them to express their views and opinions.
                </ParagraphContent>
                <Separator />
                <ParagraphContent marginY={4}>
                    Therefore, we would maintain an approachable attitude and at pains to listen to the voices and opinions of every student. Regarding constructive criticism, in order to boost our work and make improvements, we would remain a broad-minded, inclusive attitude and reflect on ourselves. At the same time, when it comes to the implementation of school policies, we would uphold the principle of “Caring”  in serving all our schoolmates in a quest to build stronger and tighter bonds between us.
                </ParagraphContent>
                <Separator />
                <ParagraphContent marginY={4}>
            ...
            <div className="w-4/5 mt-4">
                ...
                <div className="mb-6 lg:mb-10">
                    ...
                    <ParagraphContent marginY={4}>
                        則指互相的善意，乃是人與人之間的包容和親切的態度；亦指意見發表者與聆聽者之間的尊重與友善，而學生會於學生，便是一個發表意見的橋樑。本閣秉持友善的態度，聆聽每一位同學的心聲；而對於本閣的批評，亦會海納百川，接受且據之而自省改過。同時，在施政上，本閣也會秉持循中人‘Caring’的宗旨服務大家，促進循中人之間的連繫。
                    </ParagraphContent>
                    <Separator />
                </div>
                <div className="mb-6 lg:mb-10">
                    ...
                    <ParagraphContent marginY={4}>
                        而本閣的中文別稱——“<span className="font-bold">凝晞</span>”便有這個意思。“凝”有凝聚同學，強化同學對學校的歸屬感，上下一心之意，與Eunoia 的意思相似。而“晞”字則和Equinox 類近，代表新的希望和光芒，意指同學們能勇於發掘自己；勇於面對各類事物；勇於成為那顆閃耀的星。
                    </ParagraphContent>
                    <Separator />
                    <ParagraphContent marginY={4}>
